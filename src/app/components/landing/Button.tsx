...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "default", size = "default", asChild = false, href, children, ...props }, ref) => {
    ...
    const variants = {
      ...
      outline: "border border-brown-300 bg-transparent text-brown-800 hover:bg-brown-50 hover:text-brown-900 hover:border-brown-400",
      ghost: "text-brown-700 hover:text-brown-900 hover:bg-brown-50"
    }
